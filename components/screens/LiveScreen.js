...
export default LiveScreen = () => {
  return (
    <Container>
      ...
      <Header>
        <Text large bold>Transmissão</Text>
        <SearchContainer>
          <Search placeholder="Pesquise por lives stream ou jogos..." placeholderTextColor="#838383" />
          <SearchIcon>
      ...
      <SectionContainer>
        <Text medium bold>Jogos Populares</Text>
      ...
      <SectionContainer>
        <LiveGamesTitle>
          <Text medium bold>Ao Vivo</Text>
          <Text bold color="#819ee5">Todos</Text>
        </LiveGamesTitle>
      </SectionContainer>
...
const LiveGamerTitle = styled.View`
